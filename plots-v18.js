...
class CsvDataTransformer extends data_transformer_1.DataTransformer {
  ...
  constructor(props) {
    ...
    const timeFormat = this.checkTime(paramTime.values);
...
function computeXValueText(value, xAxisType) {
  if (xAxisType === "linear") {
    ...
    return date.getFullYear() + "-" + String(date.getMonth() + 1).padStart(2, "0") + "-" + String(date.getDate()).padStart(2, "0") + " " + String(date.getHours()).padStart(2, "0") + ":" + String(date.getMinutes()).padStart(2, "0") + ":" + String(date.getSeconds()).padStart(2, "0") + "." + String(Math.floor(0.1 * date.getMilliseconds())).padStart(2, "0");
  }
}
...
class PlotBooleans extends plot_1.Plot {
  ...
  constructor(props) {
    ...
    if (this.dataTransformer.xAxisType() === "datetime") {
      const ticker = new Bokeh.DatetimeTicker({desired_num_ticks: 11});
